...
import 'package:cell_explosion/pages/SettingsStateless.dart';
import 'package:cell_explosion/pages/booklet.dart';
import 'package:cell_explosion/defaults/defaults.dart';
...
import 'package:cell_explosion/widgets/ads/BannerAds.dart';
          ...
          child: ListView(
            ...
            children: [
              UserAccountsDrawerHeader(
                accountName: const Text('Cell Explosion',style: (TextStyle(fontWeight: FontWeight.bold)),),
                accountEmail: const Text('(Cebuano Version)',style: TextStyle(fontStyle: FontStyle.italic,fontSize: 12),),
