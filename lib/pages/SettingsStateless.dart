              ...
              SettingsCardTemplate(
                  ...
                  openClick: () async{
                      ...
                      if(e.title=='Theme:'){
                        ...
                        _launchUrl('https://lpz.zithvirtualsolutions.com/cell_explosion/privacy-policy');
                      }
                      else if(e.title=='Terms & Condition'){
                        _launchUrl('https://lpz.zithvirtualsolutions.com/cell_explosion/terms-and-conditions');
                      }
                  },
                buyAction: buyAction,
